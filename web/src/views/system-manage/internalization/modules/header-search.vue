...
<template>
  <ACard :title="$t(I18N_COMMON.SEARCH)" :bordered="false">
    <AForm
      ref="formRef"
      :model="model"
      :label-col="{
    ...
    >
      <ARow :gutter="[16, 16]" wrap>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="I18nInternalization('name')" name="name" class="m-0">
            <AInput v-model:value="model.name" allow-clear :placeholder="I18nEntry(I18nInternalization('name'))" />
          </AFormItem>
        </ACol>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="I18nInternalization('zhCN')" name="zhCN" class="m-0">
            <AInput v-model:value="model.zhCN" allow-clear :placeholder="I18nEntry(I18nInternalization('zhCN'))" />
          </AFormItem>
        </ACol>
        <ACol :span="24" :md="12" :lg="6">
