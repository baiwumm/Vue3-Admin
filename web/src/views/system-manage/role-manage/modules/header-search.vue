...
// 父组件传递的值
type Props = {
  updateSearchParams: (value: Partial<Api.SystemManage.RoleManageSearchParams>) => void;
};
...
const model = defineModel<Api.SystemManage.RoleManageSearchParams>('model', {
  required: true,
});
    ...
    >
      <ARow :gutter="[16, 16]" wrap>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="I18nRole('name')" name="name" class="m-0">
            <AInput v-model:value="model.name" allow-clear :placeholder="I18nEntry(I18nRole('name'))" />
          </AFormItem>
        </ACol>
        <ACol :span="24" :md="12" :lg="6">
          <AFormItem :label="I18nRole('code')" name="code" class="m-0">
            <AInput v-model:value="model.code" allow-clear :placeholder="I18nEntry(I18nRole('code'))" />
          </AFormItem>
        </ACol>
        <ACol :span="24" :md="12" :lg="6">
