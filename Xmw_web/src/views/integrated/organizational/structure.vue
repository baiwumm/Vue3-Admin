...
import { Row, Col, Card, Checkbox, RadioGroup, RadioButton, Spin, Select, SelectOption, Space } from 'ant-design-vue';
...
const collapsable = ref<boolean>(true)
const architectureType = ref<number>(1)
const spinning = ref<boolean>(false)
const labelClassName = ref<string>('bg-primary')
...
const treeProps = { label: 'org_name', children: 'children', key: 'org_id' }
